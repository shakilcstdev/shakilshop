...
const BASE_URL = "https://ShakilShoppro.reactbd.org";
...
export function generateProductMetadata(product: any): Metadata {
  ...
  const description =
    product.description ||
    `Buy ${title} online at ShakilShop. ${
...
export function generateCategoryMetadata(
  ...
  const description =
    ...
    `Browse ${productCount} products in ${title} category at ShakilShop. Find the best deals and quality items.`;
...
export function generateProductSchema(product: any) {
  ...
  // Extract brand name if it's populated
  const brandName =
    typeof product.brand === "object" ? product.brand?.name : "ShakilShop";
...
export function generateOrganizationSchema() {
  return {
    ...
    sameAs: [
      "https://facebook.com/ShakilShop",
      "https://twitter.com/ShakilShop",
      "https://instagram.com/ShakilShop",
      "https://linkedin.com/company/ShakilShop",
    ],
  };
}
...
export function generateHomeMetadata(): Metadata {
  return {
    ...
    openGraph: {
      ...
      title: "ShakilShop - Your Trusted Online Shopping Destination",
      description:
        "Discover amazing products at ShakilShop. Shop electronics, fashion, home goods and more with fast delivery.",
      images: [
        {
          url: "/og-image.jpg",
          width: 1200,
    ...
    twitter: {
      ...
      title: "ShakilShop - Your Trusted Online Shopping Destination",
      description:
        "Discover amazing products at ShakilShop. Shop electronics, fashion, home goods and more.",
      images: ["/og-image.jpg"],
    },
    alternates: {
      canonical: BASE_URL,
